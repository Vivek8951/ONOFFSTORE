...
export default function Navbar() {
  return (
    <div className="w-full flex justify-center fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100">
      <nav className="w-full max-w-[1440px] bg-white relative">
        ...
        <div className="w-full bg-black text-white py-2 px-4 text-center">
          <span className="text-[9px] font-black tracking-[0.4em] uppercase">Complimentary Express Shipping on all SMARTON Orders</span>
        </div>
        ...
        <div className="w-full grid grid-cols-3 items-center px-6 md:px-12 py-6">
          ...
          {/* Center: THE LOGO (The Hero) */}
          <div className="flex justify-center">
            <Link href="/" className="flex flex-shrink-0">
              <img 
                src="/logo.png" 
                alt="SMARTON" 
                className="h-16 md:h-28 w-auto object-contain hover:scale-105 transition-all duration-700 ease-in-out" 
              />
            </Link>
          </div>
      ...
      {/* MOBILE BOTTOM TABS (Streamlined) */}
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 z-50 flex justify-around items-center px-2 py-3 pb-safe shadow-[0_-10px_30px_rgba(0,0,0,0.05)]">
        <Link href="/" className="flex flex-col items-center gap-1 text-black">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path></svg>
          <span className="text-[8px] font-black uppercase tracking-widest">Store</span>
        </Link>
        <Link href="/shop" className="flex flex-col items-center gap-1 text-gray-400 hover:text-black">
        ...
        <Link href="/cart" className="flex flex-col items-center gap-1 text-gray-400 hover:text-black relative">
          ...
          <span className="absolute -top-1 -right-1 bg-black text-white text-[7px] w-3 h-3 rounded-full flex items-center justify-center font-black">1</span>
          <span className="text-[8px] font-black uppercase tracking-widest">Bag</span>
        </Link>
        <Link href="/my-orders" className="flex flex-col items-center gap-1 text-gray-400 hover:text-black">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>
          <span className="text-[8px] font-black uppercase tracking-widest">Shipments</span>
        </Link>
        <Link href="/login" className="flex flex-col items-center gap-1 text-gray-400 hover:text-black">
